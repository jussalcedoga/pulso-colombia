...
- An open chat requests incremental messages every four seconds during active
  use, then backs off to every 20 seconds.
...
0.25 requests/second each while active and 0.05 requests/second each when idle.
