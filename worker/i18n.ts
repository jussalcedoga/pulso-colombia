const englishErrors: Record<string, string> = {
  ...
  post_type_immutable: "A post cannot change its type after publication.",
  ...
  report_author_required: "Only the post author can edit this entry.",
  report_owner_required: "Only the post author or Pulso moderator can do that.",
